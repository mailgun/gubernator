...
// A set of int32 flags used to control the behavior of a chained rate limits in gubernator
type UnionBehavior int32

const (
	// Default behaviour to treat multiple requests as fully independent
	UnionBehavior_INDEPENDENT UnionBehavior = 0 // <- here because it is mandatory for the proto
	// Enables atomic chaining of rate limits to multiple limits, i.e. will only increment if all limits
	// have remaining capacity, otherwise will fail.
	UnionBehavior_ATOMIC_REQUESTS UnionBehavior = 1
)

// Enum value maps for UnionBehavior.
var (
	UnionBehavior_name = map[int32]string{
		0: "INDEPENDENT",
		1: "ATOMIC_REQUESTS",
	}
	UnionBehavior_value = map[string]int32{
		"INDEPENDENT":     0,
		"ATOMIC_REQUESTS": 1,
	}
)

func (x UnionBehavior) Enum() *UnionBehavior {
	p := new(UnionBehavior)
	*p = x
	return p
}

func (x UnionBehavior) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (UnionBehavior) Descriptor() protoreflect.EnumDescriptor {
	return file_gubernator_proto_enumTypes[2].Descriptor()
}

func (UnionBehavior) Type() protoreflect.EnumType {
	return &file_gubernator_proto_enumTypes[2]
}

func (x UnionBehavior) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use UnionBehavior.Descriptor instead.
func (UnionBehavior) EnumDescriptor() ([]byte, []int) {
...
func (Status) Descriptor() protoreflect.EnumDescriptor {
	return file_gubernator_proto_enumTypes[3].Descriptor()
}

func (Status) Type() protoreflect.EnumType {
	return &file_gubernator_proto_enumTypes[3]
}
...
type GetRateLimitsReq struct {
	...
	Behavior UnionBehavior   `protobuf:"varint,2,opt,name=Behavior,proto3,enum=pb.gubernator.UnionBehavior" json:"Behavior,omitempty"`
}
...
func (x *GetRateLimitsReq) GetBehavior() UnionBehavior {
	if x != nil {
		return x.Behavior
	}
	return UnionBehavior_INDEPENDENT
}
...
var file_gubernator_proto_rawDesc = []byte{
	...
	,
	...
	,
	...
	0x72, 0x65, 0x6d, 0x61, 0x69, 0x6e, 0x69, 0x6e, 0x67, 0x18, 0x03, 0x20, 0x01, 0x28, 0x03, 0x52,
	0x09, 0x72, 0x65, 0x6d, 0x61, 0x69, 0x6e, 0x69, 0x6e, 0x67, 0x12, 0x1d, 0x0a, 0x0a, 0x72, 0x65,
	0x73, 0x65, 0x74, 0x5f, 0x74, 0x69, 0x6d, 0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x03, 0x52, 0x09,
	0x72, 0x65, 0x73, 0x65, 0x74, 0x54, 0x69, 0x6d, 0x65, 0x12, 0x14, 0x0a, 0x05, 0x65, 0x72, 0x72,
	...
	0x0b, 0x32, 0x2a, 0x2e, 0x70, 0x62, 0x2e, 0x67, 0x75, 0x62, 0x65, 0x72, 0x6e, 0x61, 0x74, 0x6f,
	0x72, 0x2e, 0x52, 0x61, 0x74, 0x65, 0x4c, 0x69, 0x6d, 0x69, 0x74, 0x52, 0x65, 0x73, 0x70, 0x2e,
	...
	,
	...
	,
}
...
var file_gubernator_proto_enumTypes = make([]protoimpl.EnumInfo, 4)
...
var file_gubernator_proto_goTypes = []interface{}{
	...
	(UnionBehavior)(0),        // 2: pb.gubernator.UnionBehavior
	(Status)(0),               // 3: pb.gubernator.Status
	(*GetRateLimitsReq)(nil),  // 4: pb.gubernator.GetRateLimitsReq
	(*GetRateLimitsResp)(nil), // 5: pb.gubernator.GetRateLimitsResp
	(*RateLimitReq)(nil),      // 6: pb.gubernator.RateLimitReq
	(*RateLimitResp)(nil),     // 7: pb.gubernator.RateLimitResp
	(*HealthCheckReq)(nil),    // 8: pb.gubernator.HealthCheckReq
	(*HealthCheckResp)(nil),   // 9: pb.gubernator.HealthCheckResp
	nil,                       // 10: pb.gubernator.RateLimitResp.MetadataEntry
}
var file_gubernator_proto_depIdxs = []int32{
	6,  // 0: pb.gubernator.GetRateLimitsReq.requests:type_name -> pb.gubernator.RateLimitReq
	2,  // 1: pb.gubernator.GetRateLimitsReq.Behavior:type_name -> pb.gubernator.UnionBehavior
	7,  // 2: pb.gubernator.GetRateLimitsResp.responses:type_name -> pb.gubernator.RateLimitResp
	0,  // 3: pb.gubernator.RateLimitReq.algorithm:type_name -> pb.gubernator.Algorithm
	1,  // 4: pb.gubernator.RateLimitReq.behavior:type_name -> pb.gubernator.Behavior
	3,  // 5: pb.gubernator.RateLimitResp.status:type_name -> pb.gubernator.Status
	10, // 6: pb.gubernator.RateLimitResp.metadata:type_name -> pb.gubernator.RateLimitResp.MetadataEntry
	4,  // 7: pb.gubernator.V1.GetRateLimits:input_type -> pb.gubernator.GetRateLimitsReq
	8,  // 8: pb.gubernator.V1.HealthCheck:input_type -> pb.gubernator.HealthCheckReq
	5,  // 9: pb.gubernator.V1.GetRateLimits:output_type -> pb.gubernator.GetRateLimitsResp
	9,  // 10: pb.gubernator.V1.HealthCheck:output_type -> pb.gubernator.HealthCheckResp
