...
func (DescriptorStatus_Code) EnumDescriptor() ([]byte, []int) { return fileDescriptor1, []int{4, 0} }
...
type Descriptor struct {
	...
	Entries []*Descriptor_Entry `protobuf:"bytes,1,rep,name=entries" json:"entries,omitempty"`
...
func (m *Descriptor) GetEntries() []*Descriptor_Entry {
	if m != nil {
		return m.Entries
	}
	return nil
...
type Descriptor_Entry struct {
	Key   string `protobuf:"bytes,1,opt,name=key" json:"key,omitempty"`
	Value string `protobuf:"bytes,2,opt,name=value" json:"value,omitempty"`
}

func (m *Descriptor_Entry) Reset()                    { *m = Descriptor_Entry{} }
func (m *Descriptor_Entry) String() string            { return proto.CompactTextString(m) }
func (*Descriptor_Entry) ProtoMessage()               {}
func (*Descriptor_Entry) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{3, 0} }

func (m *Descriptor_Entry) GetKey() string {
	if m != nil {
		return m.Key
	}
	return ""
...
func (m *Descriptor_Entry) GetValue() string {
	if m != nil {
		return m.Value
	}
	return ""
...
type DescriptorStatus struct {
	...
	OfHitsAccepted int64 `protobuf:"varint,4,opt,name=of_hits_accepted,json=ofHitsAccepted" json:"of_hits_accepted,omitempty"`
...
func (m *DescriptorStatus) GetOfHitsAccepted() int64 {
	if m != nil {
...
func init() {
	...
	proto.RegisterType((*Descriptor_Entry)(nil), "pb.gubernator.Descriptor.Entry")
...
var fileDescriptor1 = []byte{
	...
	,
}
